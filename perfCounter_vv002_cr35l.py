...
def main(top_block_cls=vv002_cr35l, options=None):
    ...
    tb.start()
    tb.wait()
    print "dtv_dvb_bbheader_bb_0"
    print tb.dtv_dvb_bbheader_bb_0.pc_work_time_total();
    print "blocks_file_source_0"
    print tb.blocks_file_source_0.pc_work_time_total();
    print "digital_ofdm_cyclic_prefixer"
    print tb.digital_ofdm_cyclic_prefixer_0.pc_work_time_total();
    print "dtv_dvbt2_p1insertion_cc_0"
    print tb.dtv_dvbt2_p1insertion_cc_0.pc_work_time_total();
    print "dtv_dvb_bbscrambler_bb_0"
    print tb.dtv_dvb_bbscrambler_bb_0.pc_work_time_total();
    print "dtv_dvb_bch_bb_0"
    print tb.dtv_dvb_bch_bb_0.pc_work_time_total();
    print "dtv_dvb_ldpc_bb_0"
    print tb.dtv_dvb_ldpc_bb_0.pc_work_time_total();
    print "dtv_dvbt2_interleaver_bb_0"
    print tb.dtv_dvbt2_interleaver_bb_0.pc_work_time_total();
    print "dtv_dvbt2_cellinterleaver_cc_0"
    print tb.dtv_dvbt2_cellinterleaver_cc_0.pc_work_time_total();
    print "dtv_dvbt2_framemapper_cc_0"
    print tb.dtv_dvbt2_framemapper_cc_0.pc_work_time_total();
    print "dtv_dvbt2_freqinterleaver_cc_0"
    print tb.dtv_dvbt2_freqinterleaver_cc_0.pc_work_time_total();
    print "dtv_dvbt2_pilotgenerator_cc_0"
    print tb.dtv_dvbt2_pilotgenerator_cc_0.pc_work_time_total();
    print "dtv_dvbt2_modulator_bc_0"
    print tb.dtv_dvbt2_modulator_bc_0.pc_work_time_total();
    print "blocks_file_sink_1"
    print tb.blocks_file_sink_1.pc_work_time_total();
