...
class vv002_cr35l(gr.top_block):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self.dtv_dvbt2_pilotgenerator_cc_0 = dtv.dvbt2_pilotgenerator_cc(dtv.CARRIERS_EXTENDED, dtv.FFTSIZE_32K_T2GI, dtv.PILOT_PP7, dtv.GI_1_128, 59, dtv.PAPR_OFF, dtv.VERSION_111,
dtv.PREAMBLE_T2_SISO, dtv.MISO_TX1, dtv.EQUALIZATION_OFF, dtv.BANDWIDTH_8_0_MHZ, 32768)
        ...
        self.dtv_dvbt2_freqinterleaver_cc_0 = dtv.dvbt2_freqinterleaver_cc(dtv.CARRIERS_EXTENDED, dtv.FFTSIZE_32K_T2GI, dtv.PILOT_PP7, dtv.GI_1_128, 59, dtv.PAPR_OFF, dtv.VERSION_111,
dtv.PREAMBLE_T2_SISO)
        self.dtv_dvbt2_framemapper_cc_0 = dtv.dvbt2_framemapper_cc(dtv.FECFRAME_NORMAL, dtv.C3_5, dtv.MOD_256QAM, dtv.ROTATION_ON, 202, 3, dtv.CARRIERS_EXTENDED, dtv.FFTSIZE_32K_T2GI,
dtv.GI_1_128, dtv.L1_MOD_64QAM, dtv.PILOT_PP7, 2, 59, dtv.PAPR_OFF, dtv.VERSION_111, dtv.PREAMBLE_T2_SISO, dtv.INPUTMODE_NORMAL, dtv.RESERVED_OFF, dtv.L1_SCRAMBLED_OFF, dtv.INBAND_OFF)
...
def main(top_block_cls=vv002_cr35l, options=None):
    ...
    print("blocks_file_source_0: \t\t\t" + str(tb.blocks_file_source_0.pc_work_time_total()))
    print("digital_ofdm_cyclic_prefixer_0: \t" + str(tb.digital_ofdm_cyclic_prefixer_0.pc_work_time_total()))
    print("dtv_dvb_bbheader_bb_0: \t\t\t" + str(tb.dtv_dvb_bbheader_bb_0.pc_work_time_total()))
    print("dtv_dvb_bbscrambler_bb_0: \t\t" + str(tb.dtv_dvb_bbscrambler_bb_0.pc_work_time_total()))
    print("dtv_dvb_bch_bb_0: \t\t\t" + str(tb.dtv_dvb_bch_bb_0.pc_work_time_total()))
    print("dtv_dvb_ldpc_bb_0: \t\t\t" + str(tb.dtv_dvb_ldpc_bb_0.pc_work_time_total()))
    print("dtv_dvbt2_cellinterleaver_cc_0: \t" + str(tb.dtv_dvbt2_cellinterleaver_cc_0.pc_work_time_total()))
    print("dtv_dvbt2_framemapper_cc_0: \t\t" + str(tb.dtv_dvbt2_framemapper_cc_0.pc_work_time_total()))
    print("dtv_dvbt2_freqinterleaver_cc_0: \t" + str(tb.dtv_dvbt2_freqinterleaver_cc_0.pc_work_time_total()))
    print("dtv_dvbt2_interleaver_bb_0: \t\t" + str(tb.dtv_dvbt2_interleaver_bb_0.pc_work_time_total()))
    print("dtv_dvbt2_modulator_bc_0: \t\t" + str(tb.dtv_dvbt2_modulator_bc_0.pc_work_time_total()))
    print("dtv_dvbt2_p1insertion_cc_0: \t\t" + str(tb.dtv_dvbt2_p1insertion_cc_0.pc_work_time_total()))
    print("dtv_dvbt2_pilotgenerator_cc_0: \t\t" + str(tb.dtv_dvbt2_pilotgenerator_cc_0.pc_work_time_total()))
