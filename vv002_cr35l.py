...
# Title: Vv002 Cr35L
# Generated: Sat May 27 00:02:16 2017
##################################################
...
class vv002_cr35l(gr.top_block):
    ...
    def __init__(self):
        ...
        self.dtv_dvb_bch_ldpc_bb_0 = dtv.dvb_bch_ldpc_bb(dtv.STANDARD_DVBT2, dtv.FECFRAME_NORMAL, dtv.C3_5, dtv.MOD_OTHER)
        ...
        self.connect((self.dtv_dvb_bbscrambler_bb_0, 0), (self.dtv_dvb_bch_ldpc_bb_0, 0))
        self.connect((self.dtv_dvb_bch_ldpc_bb_0, 0), (self.dtv_dvbt2_interleaver_bb_0, 0))
