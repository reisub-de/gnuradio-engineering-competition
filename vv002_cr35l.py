...
# Title: Vv002 Cr35L
# Generated: Mon May  1 11:06:46 2017
##################################################
...
class vv002_cr35l(gr.top_block):
    ...
    def __init__(self):
        ...
        self.dtv_dvbt2_interleaver_bb_0_0 = dtv.dvbt2_interleaver_bb(dtv.FECFRAME_NORMAL, dtv.C3_5, dtv.MOD_256QAM)
        ...
        self.dtv_dvb_ldpc_bb_0_0 = dtv.dvb_ldpc_bb(dtv.STANDARD_DVBT2, dtv.FECFRAME_NORMAL, dtv.C3_5, dtv.MOD_OTHER)
        self.dtv_dvb_ldpc_bb_0 = dtv.dvb_ldpc_bb(dtv.STANDARD_DVBT2, dtv.FECFRAME_NORMAL, dtv.C3_5, dtv.MOD_OTHER)
        self.dtv_dvb_bch_bb_0_0 = dtv.dvb_bch_bb(dtv.STANDARD_DVBT2, dtv.FECFRAME_NORMAL, dtv.C3_5)
        self.dtv_dvb_bch_bb_0 = dtv.dvb_bch_bb(dtv.STANDARD_DVBT2, dtv.FECFRAME_NORMAL, dtv.C3_5)
        self.dtv_dvb_bbscrambler_bb_0_0 = dtv.dvb_bbscrambler_bb(dtv.STANDARD_DVBT2, dtv.FECFRAME_NORMAL, dtv.C3_5)
        ...
        self.blocks_interleave_0 = blocks.interleave(gr.sizeof_char*1, 64800/8)
        ...
        self.blocks_deinterleave_0 = blocks.deinterleave(gr.sizeof_char*1, 38688)

        ##################################################
        # Connections
        ##################################################
        self.connect((self.blocks_deinterleave_0, 0), (self.dtv_dvb_bbscrambler_bb_0, 0))
        self.connect((self.blocks_deinterleave_0, 1), (self.dtv_dvb_bbscrambler_bb_0_0, 0))
        self.connect((self.blocks_file_source_0, 0), (self.dtv_dvb_bbheader_bb_0, 0))
        self.connect((self.blocks_interleave_0, 0), (self.dtv_dvbt2_modulator_bc_0, 0))
        self.connect((self.digital_ofdm_cyclic_prefixer_0, 0), (self.dtv_dvbt2_p1insertion_cc_0, 0))
        self.connect((self.dtv_dvb_bbheader_bb_0, 0), (self.blocks_deinterleave_0, 0))
        self.connect((self.dtv_dvb_bbscrambler_bb_0, 0), (self.dtv_dvb_bch_bb_0, 0))
        self.connect((self.dtv_dvb_bbscrambler_bb_0_0, 0), (self.dtv_dvb_bch_bb_0_0, 0))
        self.connect((self.dtv_dvb_bch_bb_0, 0), (self.dtv_dvb_ldpc_bb_0, 0))
        self.connect((self.dtv_dvb_bch_bb_0_0, 0), (self.dtv_dvb_ldpc_bb_0_0, 0))
        self.connect((self.dtv_dvb_ldpc_bb_0, 0), (self.dtv_dvbt2_interleaver_bb_0, 0))
        self.connect((self.dtv_dvb_ldpc_bb_0_0, 0), (self.dtv_dvbt2_interleaver_bb_0_0, 0))
        ...
        self.connect((self.dtv_dvbt2_interleaver_bb_0, 0), (self.blocks_interleave_0, 0))
        self.connect((self.dtv_dvbt2_interleaver_bb_0_0, 0), (self.blocks_interleave_0, 1))
