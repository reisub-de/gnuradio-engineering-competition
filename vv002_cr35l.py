...
# Title: Vv002 Cr35L
# Generated: Fri May 19 00:13:55 2017
##################################################
...
class vv002_cr35l(gr.top_block):
    ...
    def __init__(self):
        ...
        self.dtv_dvb_bbheader_bb_0 = dtv.dvb_bbheader_bb(dtv.STANDARD_DVBT2, dtv.FECFRAME_NORMAL, dtv.C3_5, dtv.RO_0_35, dtv.INPUTMODE_NORMAL, dtv.INBAND_OFF, 168, 4000000)
