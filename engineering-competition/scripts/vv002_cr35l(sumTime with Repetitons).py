...
def main(top_block_cls=vv002_cr35l, options=None):
    ...
    for i in range(1, repetitions+1):
        ...
        tb.start()
        tb.wait()
        sumTime = sumTime + tb.dtv_dvb_bbheader_bb_0.pc_work_time_total()
        sumTime = sumTime + tb.dtv_dvb_bbscrambler_bb_0.pc_work_time_total()
        sumTime = sumTime + tb.dtv_dvb_bch_bb_0.pc_work_time_total()
        sumTime = sumTime + tb.dtv_dvb_ldpc_bb_0.pc_work_time_total()
        sumTime = sumTime + tb.dtv_dvbt2_interleaver_bb_0.pc_work_time_total()
        sumTime = sumTime + tb.dtv_dvbt2_modulator_bc_0.pc_work_time_total()
        sumTime = sumTime + tb.dtv_dvbt2_cellinterleaver_cc_0.pc_work_time_total()
        sumTime = sumTime + tb.dtv_dvbt2_framemapper_cc_0.pc_work_time_total()
        sumTime = sumTime + tb.dtv_dvbt2_freqinterleaver_cc_0.pc_work_time_total()
        sumTime = sumTime + tb.dtv_dvb_ldpc_bb_0.pc_work_time_total()
        sumTime = sumTime + tb.dtv_dvbt2_pilotgenerator_cc_0.pc_work_time_total()
        sumTime = sumTime + tb.digital_ofdm_cyclic_prefixer_0.pc_work_time_total()
        sumTime = sumTime + tb.dtv_dvbt2_p1insertion_cc_0.pc_work_time_total()
