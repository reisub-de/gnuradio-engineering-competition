...
def main(top_block_cls=vv002_cr35l, options=None):
    ...
    for i in range(1, repetitions+1):
        ...
        tb.start()
        tb.wait()
        #print("BBheader:\t\t\t" + str(tb.dtv_dvb_bbheader_bb_0.pc_work_time_total()))
        #print("BBscrambler:\t\t\t" +  str(tb.dtv_dvb_bbscrambler_bb_0.pc_work_time_total()))
        #print("BCH Encoder:\t\t\t" +  str(tb.dtv_dvb_bch_bb_0.pc_work_time_total()))
        #print("LDPC Encoder:\t\t\t" +  str(tb.dtv_dvb_ldpc_bb_0.pc_work_time_total()))
        #print("Bit Interleaver:\t\t" +  str(tb.dtv_dvbt2_interleaver_bb_0.pc_work_time_total()))
        #print("DVB-T2 Modulator:\t\t" +  str(tb.dtv_dvbt2_modulator_bc_0.pc_work_time_total()))
        #print("Cell/Time Interleaver:\t\t" +  str(tb.dtv_dvbt2_cellinterleaver_cc_0.pc_work_time_total()))
        #print("Frame Mapper:\t\t\t" +  str(tb.dtv_dvbt2_framemapper_cc_0.pc_work_time_total()))
        #print("Frequency Interleaver:\t\t" +  str(tb.dtv_dvbt2_freqinterleaver_cc_0.pc_work_time_total()))
        time = tb.dtv_dvb_ldpc_bb_0.pc_work_time_total()
        sumTime = sumTime + time
        print("LDPC:\t" +  str(time))
        #print("Pilot Generator and IFFT:\t" +  str(tb.dtv_dvbt2_pilotgenerator_cc_0.pc_work_time_total()))
        #print("OFDM Cyclic Prefixer:\t\t" +  str(tb.digital_ofdm_cyclic_prefixer_0.pc_work_time_total()))
        #print("P1 Symbol Insertion:\t\t" +  str(tb.dtv_dvbt2_p1insertion_cc_0.pc_work_time_total()))
    print(sumTime/(repetitions))
