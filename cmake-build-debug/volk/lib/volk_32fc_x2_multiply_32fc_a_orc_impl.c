...
volk_32fc_x2_multiply_32fc_a_orc_impl (orc_uint64 * ORC_RESTRICT d1, const orc_uint64 * ORC_RESTRICT s1, const orc_uint64 * ORC_RESTRICT s2, int n){
  ...
  for (i = 0; i < n; i++) {
    ...
    var40 = ptr4[i];
    /* 6: swaplq */
    var47.i = ((var40.i&ORC_UINT64_C(0x00000000ffffffff)) << 32) | ((var40.i & ORC_UINT64_C(0xffffffff00000000)) >> 32);
    /* 7: loadq */
    var41 = ptr5[i];
    /* 8: mulf */
    {
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      static const orc_uint8 bc[] = {
        1, 9, 37, 118, 111, 108, 107, 95, 51, 50, 102, 99, 95, 120, 50, 95, 
        109, 117, 108, 116, 105, 112, 108, 121, 95, 51, 50, 102, 99, 95, 97, 95, 
        111, 114, 99, 95, 105, 109, 112, 108, 11, 8, 8, 12, 8, 8, 12, 8, 
        8, 20, 8, 20, 4, 20, 4, 20, 4, 20, 4, 20, 8, 21, 1, 202, 
        32, 4, 5, 197, 36, 35, 32, 201, 33, 35, 36, 187, 37, 4, 21, 1, 
        202, 32, 37, 5, 197, 36, 35, 32, 200, 34, 35, 36, 194, 0, 33, 34, 
        2, 0, 
      };
